...
WORKING_DIR=/home/nate/Android/aosp/purenexuscmte
...
declare -a theme_packages=('ExactCalculator' 'CellBroadcastReceiver' 'Contacts' 'ContactsCommon' 'Dialer' 'InCallUI' 'Launcher3' 'LockClock' 'Messaging' 'PhoneCommon' 'PackageInstaller' 'PureNexusSettings' 'Settings' 'Stk' 'ThemeChooser')
...
git clone https://github.com/PureNexusProject/Theme-Resources.git
...
cd /home/nate/Android/aosp/purenexuscmte/Theme-Resources
